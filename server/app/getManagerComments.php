 ...
 * array('total'=>2, 'row'=>array(
            array('nickname'=>'qdurenhongcai@163.com', 'avatar'=>'http://decorationbus-companylogo.stor.sinaapp.com/1.jpg', 'date'=>'2015-12-13', 'comment'=>'是个好设计师', 'score'=>87, 'thumbnail01'=>'', 'thumbnail02'=>'', 'thumbnail03'=>'', 'thumbnail04'=>'', 'image01'=>'', 'image02'=>'', 'image03'=>'', 'image04'=>''),
            array('nickname'=>'qdurenhongcai@163.com', 'avatar'=>'http://decorationbus-companylogo.stor.sinaapp.com/1.jpg', 'date'=>'2015-12-13', 'comment'=>'是个好设计师', 'score'=>87, 'thumbnail01'=>'', 'thumbnail02'=>'', 'thumbnail03'=>'', 'thumbnail04'=>'', 'image01'=>'', 'image02'=>'', 'image03'=>'', 'image04'=>''),
        )
        );
 * */
...
$target_manager_id = 0; //所要查询的设计师
$managerCommentList = array('total'=>0, 'row'=>array()); //默认返回结果
...
if(!isset($_GET["manager"])) {
    return json_encode($managerCommentList);
}
$target_manager_id = $_GET["manager"];

//查询
function getManagerComments($counter) {
    global $managerCommentList;
    global $target_manager_id;
    ...
    $result = $conn->query("select usernickname, useravatar, commentdate, comment, score, thumbnail01, thumbnail02, thumbnail03, thumbnail04, image01, image02, image03, image04 from decoration_manager_comments where managerid=$target_manager_id LIMIT $limit_start, $limit_stop ");
    if (!$result) {
        throw new Exception('Search user score failed.');
    }

    $num_result = $result->num_rows;
    $managerCommentList['total'] = $num_result;
    ...
    for($i = 0; $i < $num_result; $i++) {
        ...
        $managerCommentList["row"][$i] = $converted_row;
    }
...
$jsonStr = getManagerComments($param_counter);
print("$jsonStr");
